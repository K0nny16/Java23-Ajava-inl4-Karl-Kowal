...
class GUI extends JFrame {
    ...
    void addCity() throws MalformedURLException {
        ...
        if (city != null && !city.isEmpty()){
            ...
            String weatherResponse = WeatherAPI.getLL(new URL("https://api.openweathermap.org/data/2.5/weather?lat="+coords[0]+"&lon="+coords[1]+"&appid=6e86d40c1ccec69010c71630afb27d8c&units=metric&lang=sv"));
